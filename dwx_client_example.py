...
class tick_processor():
    ...
    def on_bar_data(self, symbol, time_frame, time, open_price, high, low, 
                    close_price, tick_volume):
        
        print('on_bar_data:', symbol, time_frame, datetime.utcnow(), time, 
...
MT4_files_dir = 'C:/Users/guicr/AppData/Roaming/MetaQuotes/Terminal/D0E8209F77C8CF37AD8BF550E51FF075/MQL5/Files/'
